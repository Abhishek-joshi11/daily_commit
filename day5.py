...
#   This code is meant for educational purposes and can be expanded with more complex features like categories, 
#   timers, or multiplayer support.
#   Remember to have fun while coding and keep learning! 🚀